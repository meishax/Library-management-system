...
<div class="page-container">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu">
            ...
            <li class="学生表删除">
                <a href="stu_delete.jsp">
                    <i class="fa fa-bookmark-o"></i>
                    <span class="title">学生表删除</span>
                    <span class="arrow "></span>
                </a>
            ...
            <li class="书籍表增加">
                <a href="book_insert.jsp">
                    ...
                    <span class="title">书籍表增加</span>
                    <span class="arrow "></span>
                </a>

            </li>
            <li class="书籍表删除">
                <a href="book_delete.jsp">
                    <i class="fa fa-leaf"></i>
                    <span class="title">书籍表删除</span>
                    <span class="arrow "></span>
                </a>
            ...
            <li>
            <li class="书籍表修改">
                <a href="book_update.jsp">
                    <i class="fa fa-gift"></i>
                    <span class="title">书籍表修改</span>
                    <span class="arrow "></span>
                </a>
            ...
            <li class="书籍表查询">
                <a href="book_list.jsp">
                    <i class="fa fa-gift"></i>
                    <span class="title">书籍表查询</span>
                    <span class="arrow "></span>
                </a>
            </li>

            <li class="书籍状态增加">
                <a href="docbor_inset.jsp">
                    <i class="fa fa-folder-open"></i>
                    <span class="title">书籍状态增加</span>
                    <span class="arrow "></span>
                </a>
            </li>
            <li class="书籍状态删除">
                <a href="docbor_delete.jsp">
                    <i class="fa fa-folder-open"></i>
                    <span class="title">书籍状态删除</span>
                    <span class="arrow "></span>
                </a>
            </li>
            <li class="书籍状态修改">
                <a href="docbor_update.jsp">
                    <i class="fa fa-folder-open"></i>
                    <span class="title">书籍状态修改</span>
                    <span class="arrow "></span>
                </a>
            </li>
            <li class="书籍状态查询">
    ...
    <div class="page-content">
        ...
        <tr>
            <h1><font color="#7fff00">欢迎<%=session.getAttribute("userName")%>登入管理员页面</font></h1>
