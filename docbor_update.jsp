...
<form action="docbor_update" method="post" class="smart-green">
    <h1>请输入修改的书籍状态信息：</h1><br>
    <label>
        <span>借出书籍编号：</span>
        <input type="text" name="borrowedbookid"  />
    </label>
    <label>
        书籍名：<input type="text" name="borrowedbookname"><br>
        借阅人学号：
        <input type="text" name="borrowstudentsno">
        <br>
        借阅人姓名：
        <input type="text" name="borrowstudentname">
        <br>
        <label>
            <span>&nbsp;</span>
            <br>
